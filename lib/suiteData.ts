...
export const allSuites: Suite[] = [
  {
    ...
    amenities: [
      ...
      { key: 'nespresso', label: 'Nespresso & Kenyan Tea' },
    ...
    features: [
      ...
      { label: 'Balcony',      detail: 'Private balcony with Kilimanjaro views on clear mornings' },
      { label: 'Shower',       detail: 'Walk-in rain shower' },
      { label: 'Nespresso',    detail: 'Nespresso & Kenyan Tea Selection' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Housekeeping', detail: 'Daily housekeeping service' },
      { label: 'Linen',        detail: 'Premium cotton linen and bath towels' },
      { label: 'Balcony',      detail: 'Private balcony with views of the Namanga Hills' },
      { label: 'Shower',       detail: 'Walk-in rain shower' },
      { label: 'Nespresso',    detail: 'Nespresso & Kenyan Tea Selection' },
      { label: 'Climate',      detail: 'Individual climate control and blackout curtains' },
      { label: 'Safety',       detail: 'In-room electronic safe' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Housekeeping', detail: 'Daily housekeeping service' },
      { label: 'Linen',        detail: 'Premium cotton linen and bath towels' },
      { label: 'Balcony',      detail: 'Private balcony with garden views' },
      { label: 'Shower',       detail: 'Walk-in rain shower' },
      { label: 'Nespresso',    detail: 'Nespresso & Kenyan Tea Selection' },
      { label: 'Climate',      detail: 'Individual climate control and blackout curtains' },
      { label: 'Safety',       detail: 'In-room electronic safe' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Housekeeping', detail: 'Daily housekeeping service' },
      { label: 'Linen',        detail: 'Premium cotton linen and bath towels' },
      { label: 'Balcony',      detail: 'Private balcony per room, with garden views' },
